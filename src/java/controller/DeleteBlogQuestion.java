 ...
 * @author ADMIN
 */
@WebServlet(name = "DeleteBlogQuestion", urlPatterns = {"/deleteblogquestion"})
public class DeleteBlogQuestion extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        blogquestionDAO.deleteBlogQuestion(qid);
